...
import com.dragonjic.cubes.events24.databinding.FragmentFavouritesBinding;
import com.dragonjic.cubes.events24.ui.adapter.EventsAdapter;
...
public class FavouritesFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.buttonConcert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
